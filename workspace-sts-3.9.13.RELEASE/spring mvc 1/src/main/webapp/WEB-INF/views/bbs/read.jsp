		...
		<div class="card">
			...
			<ul class="list-group list-group-flush">
				...
				<li class="list-group-item">
					<div class="row justify-content-end">
						<div class="col-auto">
							<a class="btn btn-warning" role="button" href="${basePath}/bbs/edit?num=${post.num}">수정</a>
						</div>
						<div class="col-auto">
				...
				<li class="list-group-item">
					<div class="row justify-content-end">
						<div class="col-auto">
							<a id="goto-list-button" class="btn btn-primary" role="button" href="${basePath}/bbs?pageNum=${page.pageNum}&pageSize=${page.pageSize}${searchParams}">목록</a>
						</div>
					</div>
				</li>
				<!-- /댓글 페이지 버튼 -->
...
<script type="text/javascript" src="${basePath}/resources/bbs/read.js"></script>
<script type="text/javascript" src="${basePath}/resources/bbs/commentService.js"></script>
